...
fig1=(ggplot(train_data, aes(x='factor(quarter)', fill='factor(down)')) +
geom_bar()+
labs(
    x='Quarter',
    y = "Number of Plays",
...
theme_minimal() +
theme(figure_size=(4, 2.5), text=element_text(size=8))
)
fig1
```
...
fig2=(ggplot(train_data, aes(x='factor(quarter)', y='time_remaining')) +
geom_boxplot()+
labs(
...
fig4=(ggplot(train_data, aes(x='gametime_remaining', y='score_diff')) +
...
ax[0].set_title("Random Forest Classification", fontsize=9)
...
ax[1].set_title("XGBoost Classification", fontsize=9)
...
ax[0].set_title("Random Forest", fontsize=9)

ax[1].barh(imp_df_xgb['feature'], imp_df_xgb["importance"])
ax[1].set_title("XGBoost", fontsize=9)
